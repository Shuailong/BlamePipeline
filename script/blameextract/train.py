...
from blamepipeline.blameextract import BlameExtractor
from blamepipeline.blameextract import utils, config
...
MODEL_DIR = os.path.join(DATA_ROOT, 'models/blameextract')
